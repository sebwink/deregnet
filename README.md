...
```sh
docker/named-user/run sebwink/deregnet:latest --help
```
...
```sh 
docker/name-user/run sebwink/deregnet:latest --graph test/kegg_hsa.graphml --scores test/data/score.csv --sep , --graph-id-attr ensembl
``` 
